                               ...
                               <!--<div class="col-lg-6 d-none d-lg-block bg-login-image"></div>-->
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <form action="/modProducto" class="user" method="POST">
                                            @csrf
                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-user"
                                                    name="id" aria-describedby="emailHelp"
                                                    placeholder="Id*" value="{{$producto->id_producto}}" hidden="true">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-user"
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-user"
                                                    name="descripcion" placeholder="Descripcion" value="{{$producto->descripcion}}">
                                            </div>
                                            <div class="form-group">
