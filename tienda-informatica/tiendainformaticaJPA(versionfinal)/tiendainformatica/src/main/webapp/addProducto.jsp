                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Añade un nuevo producto</h1>
                                        </div>
                                        <form action="AdminServletPrincipal" class="user" method="POST">
                                            ...
                                            <div class="form-group">
                                                <select  name="categoria" class="form-control custom-select custom-select-lg mb-3">
                                                    ...
                                                    <option value="4">Tarjetas graficas</option>
                                                    <option value="5">Memorias RAM</option>
                                            ...
                                            <div class="text-center">
                                            <input type="submit" id="operaciones" name="operaciones" value="Agregar producto" class="btn btn-primary btn-user btn-block">
                                            </div>
                                        </form>
                                        <br>
                                        <div class="text-center">
